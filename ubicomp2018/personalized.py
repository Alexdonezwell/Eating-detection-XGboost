...
for subj in subj_list:
    ...
    for fold in range(14):
        ...
        df_results.to_csv(os.path.join(personalized_folder, "prediction_day_{}.csv".format(fold)))
        ...
        np.savetxt(os.path.join(personalized_folder, "day_{}.csv".format(fold)), cm, fmt='%d')
    ...
    np.savetxt(os.path.join(personalized_folder, "cm_total.csv".format(fold)), cm_total, fmt='%d')
    ...
    df_result.to_csv(os.path.join(personalized_folder, '{}.csv'.format(subj)))
    ...
    with open(os.path.join(personalized_folder, 'latex.txt'), 'w') as f:
        f.write(latex)
